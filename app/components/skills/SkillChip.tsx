...
export default function SkillChip({ name, icon, tone = "color" }: SkillChipProps) {
  ...
  return (
    <span className="inline-flex items-center gap-2 rounded-full border border-black/10 bg-white px-3 py-1.5 text-sm text-neutral-700 transition duration-150 hover:scale-[1.03] hover:border-black/20 hover:bg-neutral-100 dark:border-white/10 dark:bg-neutral-900/60 dark:text-neutral-200 dark:hover:border-white/20 dark:hover:bg-neutral-900/80">
      {isMono ? (
        <span
          aria-hidden="true"
